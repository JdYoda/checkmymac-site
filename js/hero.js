...
// Тёплой подсветки в нижней части сцены нет намеренно (решение Юры 2026-08-15).
// Здесь стоял PointLight, освещавший батарею, — он заливал полкорпуса и читался
// как свечение, просвечивающее сквозь мак. Перенос ламп к динамикам, ограничение
...
function resize() {
  ...
  // Узкий кадр — это съёмка мобильного постера (?poster=1): живая сцена на
